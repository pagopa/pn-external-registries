...
public class AooUoIdsController implements AooUoIdsApi {
    ...
    @Override
    public Mono<ResponseEntity<FilteredPaIdsResponseDto>> getFilteredAooUoIdV2Private(List<@Pattern(regexp = "^[ -~ ]*$") @Size(min = 1, max = 50) String> id, ServerWebExchange exchange) {
