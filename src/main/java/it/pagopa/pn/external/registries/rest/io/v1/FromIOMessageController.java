...
import it.pagopa.pn.external.registries.generated.openapi.server.io.v1.dto.NotificationDisclaimerResponseDto;
...
public class FromIOMessageController implements FromIoMessageApi {
    ...
    @Override
    public Mono<ResponseEntity<NotificationDisclaimerResponseDto>> notificationDisclaimer(String xPagopaPnUid, String iun, final ServerWebExchange exchange) {
